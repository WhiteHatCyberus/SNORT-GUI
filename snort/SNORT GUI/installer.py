...
sudo_password = tkinter.simpledialog.askstring("Setting up", "\nEnter your administrator password: (Note: Once set,\nadmin password cannot be changed, incase if you \nintend to change the password, reinstall the \napplication)\n", show='*')
...
if(sudo_password is None):
    ...
    subprocess.run(['mkdir', 'resources/temp'])
